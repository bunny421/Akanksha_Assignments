...
public partial class NorthWindContext : DbContext
{
    ...
    public virtual DbSet<VwCustomerOrderReview> VwCustomerOrderReviews { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-RVHQKRN\\SQLEXPRESS;initial catalog=NORTHWND;Integrated Security=true;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CustomPr__3214EC07259DBCF0");
        ...
        modelBuilder.Entity<VwCustomerOrderReview>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_CustomerOrderReview");
