...
namespace PartialViewDemo.Controllers
{
    public class HomeController : Controller
    {
        ...
        Employee emp = new Employee()
        {
            EmpId = 1,
            EmpName = "Akanksha",
            Email = "akankshasankhyan421@gmail.com",
            Description = "Abundance flows to me effortlessly.Everything I touch turns to gold.I am a magnet for money.My dreams are becoming reality."
        };
